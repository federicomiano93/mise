...
export async function editTab(tab) {
  ...
  if (!(await confirmDialog({ message: t('calc.editTheseQuantitiesThe'), okLabel: t('ui.edit'), cancelLabel: t('ui.cancel') }))) return;
  clearRevealed(tab);
...
async function startEdit(id) {
  if (!(await confirmDialog({ message: t('calc.editThisLog'), okLabel: t('ui.edit'), cancelLabel: t('ui.cancel') }))) return;
  openLogEdit(id);
}
