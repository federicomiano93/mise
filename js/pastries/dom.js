// dom.js — tiny DOM construction helpers for the Pastries screen.
//
// A self-contained copy of js/catalogue/dom.js: the project rule is that a
// feature folder never imports from another feature's folder, so Pastries owns
// its own copy rather than reaching into js/catalogue/. Kept in sync by hand if
// the shared idea ever changes.
//
// Like the catalogue's copy, this one has no groupBy(): only Orders groups rows
// by a key, and an unused export is one more thing to keep in sync for nothing.
//
